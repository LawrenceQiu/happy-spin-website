          ...
          <div className="footer-brand">
            ...
            <div className="footer-brand-text">
              ...
              <div className="footer-socials">
                <a href="https://www.instagram.com/happyspin.tt/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="footer-social-icon">
                ...
                <a href="https://www.facebook.com/profile.php?id=61590020002196" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="footer-social-icon">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
